...
// DBG: got MemberExpr -> setting bounds for 'Nested' reference to 8
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[N:%.*]] = getelementptr inbounds nuw i8, ptr addrspace(200) [[S:%.*]], i64 4
// CHECK-NEXT:    [[TMP0:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[N]], i64 8)
// CHECK-NEXT:    tail call addrspace(200) void @_Z17do_stuff_with_refR6Nested(ptr addrspace(200) noundef nonnull align 4 dereferenceable(8) [[TMP0]]) #[[ATTR3:[0-9]+]]
// CHECK-NEXT:    [[TMP1:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[N]], i64 4)
// CHECK-NEXT:    tail call addrspace(200) void @_Z17do_stuff_with_refRi(ptr addrspace(200) noundef nonnull align 4 dereferenceable(4) [[TMP1]]) #[[ATTR3]]
// CHECK-NEXT:    [[TMP2:%.*]] = tail call addrspace(200) ptr addrspace(200) @llvm.cheri.cap.bounds.set.i64(ptr addrspace(200) nonnull [[S]], i64 4)
// CHECK-NEXT:    tail call addrspace(200) void @_Z17do_stuff_with_refRf(ptr addrspace(200) noundef nonnull align 4 dereferenceable(4) [[TMP2]]) #[[ATTR3]]
// CHECK-NEXT:    ret void
//
// HYBRID-LABEL: @_Z18test_subobject_refR10WithNested(
// HYBRID-NEXT:  entry:
// HYBRID-NEXT:    [[N:%.*]] = getelementptr inbounds nuw i8, ptr [[S:%.*]], i64 4
...
// CHECK-NEXT:  entry:
// CHECK-NEXT:    [[N:%.*]] = getelementptr inbounds nuw i8, ptr addrspace(200) [[S:%.*]], i64 4
// CHECK-NEXT:    tail call addrspace(200) void @_Z17do_stuff_with_ptrP6Nested(ptr addrspace(200) noundef nonnull [[N]]) #[[ATTR3]]
// CHECK-NEXT:    ret void
//
