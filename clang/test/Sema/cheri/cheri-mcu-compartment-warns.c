// RUN: %clang_cc1 %s -o - -triple riscv32cheriot-unknown-unknown -emit-llvm -mframe-pointer=none -mcmodel=small -target-abi cheriot -Oz -Werror -verify=libcall
// RUN: %clang_cc1 %s -o - -triple riscv32cheriot-unknown-unknown -emit-llvm -mframe-pointer=none -mcmodel=small -target-abi cheriot -Oz -Werror -verify=wrong-compartment -cheri-compartment=wrong
